...
A IA deve escanear dinamicamente as ferramentas locais disponíveis, identificando e selecting recursos para criação de design systems, análise de teoria das cores, validações WCAG de acessibilidade e engenharia CSS. Justifique a seleção.
...
- [ ] O documento contém a definição completa de variáveis cromáticas 60-30-10 in CSS?
